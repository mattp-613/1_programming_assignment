...
The java executable DBScan must be ran with three arguments given. You can run it with different constructors but this is the most optimal way to do so.
